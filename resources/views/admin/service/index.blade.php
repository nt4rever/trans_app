    ...
    <div class="container-fluid pt-3">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-tools">
                            <select name="select_quantity_view" class="form-control">
                                <option value="">Hiển thị: {{ count($all_service) }}</option>
                    ...
                    <div class="card-body table-responsive">
                        <table class="table table-hover">
                            ...
                            <style>
                                #service_order .ui-state-highlight {
                                    padding: 24px;
                ...
                <div class="card-tools">
                    <a href="{{ URL::to('/admin/service/create') }}"><button class="btn btn-outline-info">Thêm dịch
                            vụ</button></a>
    ...
    @push('custom-scripts')
        <script>
            $(function() {
                ...
                $('#service_order').sortable({
                    placeholder: 'ui-state-highlight',
                    update: function(event, ui) {
                        var _token = $('input[name=_token]').val();
                        var url = $('input[name=my_url]').val();
                        var page_id_array = new Array();
                        $('#service_order tr').each(function() {
                            page_id_array.push($(this).attr('id'));
                        });
                        $.ajax({
                            type: "POST",
                            url: url + '/admin/service/arrange-service',
                            data: {
