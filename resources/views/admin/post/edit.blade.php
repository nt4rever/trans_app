        ...
        <div class="row">
            <div class="col-md-7 mt-3">
                ...
                <div class="card card-primary">
                    ...
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form role="form" action="{{ URL::to('/admin/post/update/'.$post->post_id) }}" method="post"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="card-body">
                            <div class="form-group">
                                <label for="post_name">Tên tin tức</label>
                                <input type="text" class="form-control" id="post_name" name="post_name"
                                    placeholder="tin tức dịch thuật ..." required value="{{ $post->post_name }}">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <img src="{{ URL::asset('uploads/post/' . $post->post_image) }}"
                                    alt="post-img" style="width: 150px">
                            </div>
                            <div class="form-group">
