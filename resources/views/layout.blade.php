...
<body data-spy="" data-target=".fixed-top">
    ...
    <nav class="navbar navbar-expand-lg fixed-top navbar-light">
        <div class="container">
            ...
            <!-- Image Logo -->
            <a class="navbar-brand logo-image" href="{{ URL::to('/') }}"><img
                    src="{{ URL::asset('frontend/custom/nmt-logo.png') }}" alt="alternative"></a>
    ...
    <script>
        ...
        chatbox.setAttribute("page_id", "409764229515442");
